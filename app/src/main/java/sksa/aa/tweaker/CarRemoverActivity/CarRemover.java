...
public class CarRemover extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        String getCars = runSuWithCmd( path + "/sqlite3 /data/data/com.google.android.projection.gearhead/databases/carservicedata.db " + "'SELECT manufacturer,model FROM allowedcars;'" ).getInputStreamLog();
        ...
        String getIds = runSuWithCmd( path + "/sqlite3 /data/data/com.google.android.projection.gearhead/databases/carservicedata.db " + "'SELECT vehicleidclient FROM allowedcars;'" ).getInputStreamLog();
        ...
        fab.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick( View view ) {
                ...
                final ProgressDialog dialog = ProgressDialog.show( CarRemover.this, "", getString( R.string.tweak_loading ), true );
                ...
                runOnUiThread( new Thread() {
                    ...
                    public void run() {
                        ...
                        Log.v( "CarRemover", runSuWithCmd( path + "/sqlite3 /data/data/com.google.android.projection.gearhead/databases/carservicedata.db " + "'" + finalCommand + "'" ).getStreamLogsWithLabels() );
