...
/*        nospeed = findViewById(R.id.nospeed);
    ...
    public void messageAutoRead() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_message_autoread;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );

                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_message_autoread AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if ( suitableMethodFound ) {
                    ...
                    appendText( logs, "\n\n--  run SQL method   --" );
                    appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_speed_hack;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );

                    appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_speed_hack AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void multiDisplay() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS multi_display;" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER multi_display AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n-- Run SQL Commands  --" );
                {
                    ...
                    appendText( logs, "\n\n--  run SQL method   --" );
                    appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_six_tap;\n" + finalCommand + "DELETE FROM Flags WHERE name LIKE \'%speedbump%\';'" ).getStreamLogsWithLabels() );

                    appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_six_tap AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void coolwalkdaynightpatch() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS coolwalk_daynight_tweak;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER coolwalk_daynight_tweak AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void disableBatteryWarning() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS battery_saver_warning;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );

                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER battery_saver_warning AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void battOutline() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_battery_outline;\n\n" + finalCommand + "'" ).getStreamLogsWithLabels() );

                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_battery_outline AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void activateCoolwalk() {
        ...
        finalCommand.append( System.getProperty( "line.separator" ) );
        finalCommand.append( "INSERT OR REPLACE INTO FlagOverrides (packageName, flagType,  name, user, boolVal, committed) VALUES (\'com.google.android.p   rojection.gearhead\',  0,\'Coolwalk__semi_wide_vertical_enabled\', '' ,1,0);" );
        finalCommand.append( System.getProperty( "line.separator" ) );
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_activate_coolwalk;\n DROP TRIGGER IF EXISTS aa_deactivate_coolwalk;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_activate_coolwalk AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void deactivateCoolwalk() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_deactivate_coolwalk;\nDROP TRIGGER IF EXISTS aa_activate_coolwalk;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_deactivate_coolwalk AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void activateMaterialYou() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_material_you;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_material_you AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void activateAssistantTips() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_activate_assistant_tips;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_activate_assistant_tips AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void activatesmsdecline() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_activate_declinesms;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_activate_declinesms AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void newSeekbar() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_new_seekbar;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_new_seekbar AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void forceNoBt() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS bluetooth_pairing_off;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER bluetooth_pairing_off AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void disableTelemetry() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n-- Run SQL Commands  --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS kill_telemetry;" + "DELETE FROM Flags WHERE name LIKE \'%telemetry%\' AND packageName=\'com.google.android.projection.gearhead\';\n" + "DELETE FROM Flags WHERE name LIKE \'%telemetry%\' AND packageName=\'com.google.android.gms.car\';" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER kill_telemetry AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void uxprototypeTweak( URL URL ) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n-- Run SQL Commands  --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS uxprototype_tweak;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER uxprototype_tweak AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void setHunDuration( View view, final int value ) {
        ...
        runOnUiThread( new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n-- Run SQL Commands  --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_hun_ms;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_hun_ms AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void setMediaHunDuration( View view, final int value ) {
        ...
        runOnUiThread( new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_media_hun;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );

                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_media_hun AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void setUSBbitrate( final double value ) {
        ...
        runOnUiThread( new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n-- Run SQL Commands  --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_bitrate_usb;\n DELETE FROM Flags WHERE name LIKE \'VideoEncoderParamsFeature%\';" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_bitrate_usb AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void setWiFiBitrate( final double value ) {
        ...
        runOnUiThread( new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_bitrate_wireless;\n DELETE FROM Flags WHERE name LIKE \'VideoEncoderParamsFeature%\';\n" + finalCommand + "'" ).getStreamLogsWithLabels() );

                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_bitrate_wireless AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    private void inertialScrollTweak() {
        ...
        runOnUiThread( new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_inertial_scroll;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_inertial_scroll AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    private void verticalBarTweak() {
        ...
        runOnUiThread( new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS aa_vertical_bar;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );


                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER aa_vertical_bar AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
    ...
    public void forceWideScreen( View view, final int value ) {
        ...
        runOnUiThread( new Thread() {
            ...
            public void run() {
                ...
                appendText( logs, "\n\n--  run SQL method   --" );
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'DROP TRIGGER IF EXISTS force_ws;\n DROP TRIGGER IF EXISTS force_no_ws;\n" + finalCommand + "'" ).getStreamLogsWithLabels() );
                ...
                appendText( logs, runSuWithCmd( path + "/sqlite3 -batch /data/data/com.google.android.gms/databases/phenotype.db " + "'CREATE TRIGGER " + decideWhat + " AFTER DELETE\n" + "On FlagOverrides\n" + "BEGIN\n" + finalCommand + "END;'\n" ).getStreamLogsWithLabels() );
